...
4. A custom color palette must be created in order to distinguish between categories defined by DynamicPATCH. You can create this yourself, or use the [color_ramp.clr](color_ramp.clr) file on our repository to automatically load this palette in QGIS.
...
For more detailed information on graph interpretation, zoomed-in maps of DynamicPATCH, and the full analysis, please review the attached presentation: 
[Dynamic Patch Analysis of Coastal Mangroves in Indonesia](Dynamic_Patch_Coastal_mangrove.pdf).
[test](Dynamic_Patch_Coastal_mangrove.pdf)
